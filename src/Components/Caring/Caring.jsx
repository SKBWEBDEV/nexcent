      ...
      <Container>
        ...
        <div className="mt-[16px]  md:flex md:justify-between">
          ...
          <div className="relative">
            <img src={Cheina} alt="" />
            <div className="text-center rounded-md absolute top-[190px] left-5 md:left-[25px] px-[5px] md:px-[16px] py-[16px] bg-[#F5F7FA] shadow-lg 
          ...
          <div className="relative mt-20 md:mt-0">
            ...
            <div className="text-center rounded-md absolute top-[190px]  md:left-[30px] px-[5px] md:px-[30px] 
            py-[16px] bg-[#F5F7FA] shadow-lg  ml-7
            shadow-[#ABBED1]/40 w-fit">
