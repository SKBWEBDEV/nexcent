      ...
      <Container>
        ...
        <div className="mt-[16px]  md:flex md:justify-between">
          ...
          <div className="relative">
            <img src={Cheina} alt="" />
            <div className="text-center rounded-md absolute top-[190px] ml-8 md:ml-[25px] px-[5px] md:px-[16px] py-[16px] bg-[#F5F7FA] shadow-lg 
          ...
          <div className="relative mt-20 md:mt-0">
            ...
            py-[16px] bg-[#F5F7FA] shadow-lg  md:ml-7 ml-10
            shadow-[#ABBED1]/40 w-fit">
